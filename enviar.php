...
mail("contato@economais.me","$assunto","
Nome: $nome
Email: $email
Assunto: $assunto
...
echo "Enviando mensagem..."; //aí mostramos no navegador da pessoa que enviou o email uma mensagem de sucesso
header("location:http://www.economais.me/");
